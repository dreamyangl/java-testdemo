...
public class SerialPortRXTX extends com.intelligt.modbus.jlibmodbus.serial.SerialPort implements SerialPortEventListener {
    ...
    public SerialPortRXTX(SerialParameters sp) {
        super(sp);
    }
